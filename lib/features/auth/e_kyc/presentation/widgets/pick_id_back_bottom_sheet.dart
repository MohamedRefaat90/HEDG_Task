...
class PickIDBackBottomSheet extends StatelessWidget {
  const PickIDBackBottomSheet({super.key});
  @override
      ...
      child: Padding(
        ...
        child: Column(children: [
          CustomBTN(
              ...
              press: () async {
                context.read<EKycCubit>().idBack =
                    await picker.pickImage(source: ImageSource.gallery);
                if (context.mounted) {
                  if (context.read<EKycCubit>().idBack != null) {
